...
public SpecialPermissionForm(int formId, String year, String term,
		String dept1, String dept2, String dept3, String dept4, String course1,
		...
		String permission2, String permission3, String permission4) {
	super();
	this.formId = formId;
	this.year = year;
	this.term = term;
